package com.android.baselib.view.bottomsheetdialogfragment
...
abstract class BaseBottomSheetDialogFragment <B : ViewDataBinding, T : IPresenter> : BottomSheetDialogFragment(),
    IView {
